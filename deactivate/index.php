<?php
require_once '../includes/api-manger.inc.php';
...
<head>
    <meta charset="utf-8"/>
    <title>Project - Deactivate license</title>
    ...
    <div class="section">
        <div class="columns is-centered">
            <div class="column is-two-fifths">
                <center>
                    <h1 class="title" style="padding-top: 20px">Project Deactivate license</h1><br>
                </center>
                <div class="box">
...
<div class="content has-text-centered">
    <p>Copyright <?php echo date('Y'); ?> Daryan, All rights reserved.</p><br>
</div>
</body>
</html>